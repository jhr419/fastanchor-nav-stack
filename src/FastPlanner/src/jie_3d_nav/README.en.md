...
When saving a map package, the GUI defaults to the current user's `~/maps` directory. If you choose a custom save root, make sure the current user can write to it.
