...
class Tomogram:
    ...
    def init_kernel(self):
        self.tomography_kernel = tomography_kernel(
            self.resolution,
            self.map_dim_x,
            self.map_dim_y,
            self.n_slice_init,
        ...
        self.inflation_kernel = inflation_kernel(
            self.map_dim_x,
            self.map_dim_y,
    ...
    def init_mapping_env(self, center, map_dim_x, map_dim_y, n_slice_init, slice_h0):
    ...
    def clear_map(self):
        ...
        self.grad_mag_sq *= 0.0
        self.grad_mag_max *= 0.0
        self.trav_cost *= 0.0
        self.inflated_cost *= 0.0
