...
// ROS2: 使用 livox_ros_driver2 的消息类型（与 rosbag2 记录的消息类型一致）
...
public:
    ...
    /* topic reader */
    void receive_points(const livox_ros_driver2::msg::CustomMsg::ConstSharedPtr &msg);
    void receive_points_ntu(const sensor_msgs::msg::PointCloud2::ConstSharedPtr &msg);
    void receive_points_velodyne(const sensor_msgs::msg::PointCloud2::ConstSharedPtr &msg);
    // void receive_points(const sensor_msgs::msg::PointCloud2::ConstSharedPtr &msg);
    void receive_imu(const sensor_msgs::msg::Imu::ConstSharedPtr& msg);
    void receive_wheel(const lio::msg::WheelInfo::ConstSharedPtr& msg);
