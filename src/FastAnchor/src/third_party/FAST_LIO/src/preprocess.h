...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  // 设置输入点云的统一坐标系预旋转，角度来自 YAML 中的 [roll, pitch, yaw]，单位 rad。
...
private:
  ...
  // 将原始雷达点从传感器输入坐标系旋转到 FAST_LIO 使用的输入坐标系。
  void rotate_input(double x, double y, double z, PointType &pt) const;
